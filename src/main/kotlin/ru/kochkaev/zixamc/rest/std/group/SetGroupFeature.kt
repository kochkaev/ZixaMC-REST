...
object SetGroupFeature: RestMethodType<SetGroupFeature.Request, GroupData>(
    ...
    result = MethodResults.create(HttpStatusCode.OK,
        HttpStatusCode.BadRequest to "Request body is empty, key is invalid or data is not provided".methodResult(),
    ...
    method = { sql, permissions, params, body ->
        if (body == null) {
            ...
            HttpStatusCode.BadRequest.result("Data is required")
        } else {
